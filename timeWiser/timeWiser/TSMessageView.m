...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        if (fontName != nil) {
            ...
            [self.titleLabel setFont:[UIFont fontWithName:@"AvenirNext-Medium" size:fontSize]];
        }
        ...
        if ([subtitle length])
        {
            ...
            if (fontName != nil) {
                ...
                [self.contentLabel setFont:[UIFont fontWithName:@"Avenir Next" size:fontSize]];
            }
        ...
        if ([buttonTitle length])
        {
            ...
            self.button.titleLabel.font = [UIFont fontWithName:@"AvenirNext-Medium" size:14.0];
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    if ([self.subtitle length])
    {
        ...
        currentHeight = self.contentLabel.frame.origin.y + self.contentLabel.frame.size.height + 5.0;
    }
    else
    {
        // only the title was set
        currentHeight = self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 5.0;
    }
